...
public class GameView extends View {
    ...
    public GameView(Context context, @Nullable AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= 21){
            ...
            builder.setAudioAttributes(audioAttributes).setMaxStreams(25);
    ...
    private void initPipe() {
        ...
        for (int i = 0; i < sumpipe; i++){
            if (i < sumpipe/2){
                ...
                this.arrPipes.get(this.arrPipes.size() - 1).setBm(BitmapFactory.decodeResource(getResources(), R.drawable.pipe1));
            }
        }
